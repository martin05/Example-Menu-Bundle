...
use Martin\ExampleMenuBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MartinExampleMenuBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("MartinExampleMenuBundle:Menu:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MartinExampleMenuBundle:Menu')->find($id);
     ...
     * @Method("PUT")
     * @Template("MartinExampleMenuBundle:Menu:edit.html.twig")
     */
